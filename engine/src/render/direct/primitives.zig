...
const gouraud = @import("gouraud.zig");

pub const PreparedGouraudTriangle = gouraud.PreparedGouraudTriangle;
pub const prepareGouraudTriangle = gouraud.prepareGouraudTriangle;
pub const drawGouraudTriangle = gouraud.drawGouraudTriangle;
pub const drawPreparedGouraudTrianglePrepared = gouraud.drawPreparedGouraudTrianglePrepared;
pub const drawPreparedGouraudTriangleBlock = gouraud.drawPreparedGouraudTriangleBlock;
...
pub fn drawSolidTriangleWithDepths(
    ...
    const depth_plane = if (vertex_depths) |depths| gouraud.prepareDepthPlane(triangle, depths) else null;
...
pub fn edgeStepX(a: Point2i, b: Point2i) i64 {
    return @as(i64, b.y) - @as(i64, a.y);
}

pub fn edgeStepY(a: Point2i, b: Point2i) i64 {
    return @as(i64, a.x) - @as(i64, b.x);
}

pub fn setPixel(target: FrameTarget, x: i32, y: i32, color: u32, depth_value: ?f32) void {
...
pub fn targetBounds(target: FrameTarget) Rect2i {
    const screen = Rect2i{
        .min_x = 0,
        .min_y = 0,
