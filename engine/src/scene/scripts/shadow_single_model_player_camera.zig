...
fn stepPlayerBody(state: *PlayerCameraState, camera_position: *scene_math.Vec3, yaw: f32, pitch: f32, input_state: *const script_host.ScriptInputState, delta_seconds: f32) void {
...
fn stepPlayerBodySubstep(state: *PlayerCameraState, camera_position: *scene_math.Vec3, yaw: f32, pitch: f32, input_state: *const script_host.ScriptInputState, dt: f32) void {
