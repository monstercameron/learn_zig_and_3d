...
This document is a design note, not a guarantee that every item is already implemented. It captures the sizing and data-layout decisions that make sense for the current CPU-first renderer.
